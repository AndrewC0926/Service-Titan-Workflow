"""Project delivery method: extraction coercion, and the resolve._absorb
roll-up from Signal onto Project (fill-only-if-null, same discipline as
water_source_stated -- see test_water_risk.py). See Project.delivery_method's
docstring in app/models.py for the "who selects the equipment" reasoning."""
