...
OVERFLOW_LABELS = {
    ...
    "Record capture", "Hospitals", "Line card", "Reference", "Firms", "Contacts", "Map",
    "Source health", "Assumptions", "Add signal",
}
...
def test_command_palette_json_has_all_twenty_one_destinations(client, db_session, cfg):
    import json
    r = client.get("/board", headers=AUTH)
